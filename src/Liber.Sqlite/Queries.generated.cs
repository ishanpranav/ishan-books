...
internal static class Queries
{
    ...
    public const string SelectCompany = "SELECT\"Name\",\"NextAccountNumber\",\"NextTransactionNumber\",\"Type\",\"Color\"FROM \"main" +
    "\".\"Company\"LIMIT 1;";
