            ...
            <xsl:with-param name="table">
                <thead>
                    ...
                    <tr>
                        <th></th>
                        <th class="heading">
                            <xsl:value-of select="liber:gets('average-daily-balance')"/>
                        </th>
                    </tr>
                </thead>
                <tbody>
                    <xsl:for-each select="company/account[average-daily-balance != 0]">
                        <tr>
                            <td class="left account">
                                <xsl:value-of select="name"/>
                            </td>
                            <td class="right">
                                <xsl:value-of select="liber:fm(type, average-daily-balance)"/>
                            </td>
                        </tr>
                    </xsl:for-each>
                </tbody>
